...
| **CAT1_Categorical_Dominant** | All QIs categorical, moderate risk, l_diversity metric | **PRAM** |
...
- `tests/test_rule_selection_known_cases.py` — 42 regression tests verifying each rule fires correctly (incl. PUB1/SEC1/REG1)
- `tests/empirical/reports/SUMMARY.md` — Empirical validation results (80 runs, 3 crossovers)
- `tests/empirical/reports/COMBINED_SUMMARY.md` — Cross-metric validation comparing reid95 and k_anonymity outcomes
- `tests/parity/` — Python vs R/sdcMicro parity test suite (8 tests across LOCSUPR and NOISE on testdata, CASCrefmicrodata, free1, francdat)
- `docs/sdcmicro_evaluation.md` — Engine output demonstration on sdcMicro-bundled datasets
